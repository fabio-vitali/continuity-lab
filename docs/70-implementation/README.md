...
**MI-001D — Retained Level 1 Candidate Deliberate Supersession** is the sole selected next iteration with status `selected-contract-required`; it is not authored, authorized, or executed. MI-002, genuine invocation confirmation, candidate reconstruction, installation, supersession, and broader implementation remain blocked.
