...
**MI-001C — Original MI-001 Output Artifact Evidence Recovery** is the sole selected next iteration with status `selected-contract-required`. It is not authorized for execution until a separate reviewed and committed contract exists. It may not reconstruct, edit, install, or invoke the Skill.
