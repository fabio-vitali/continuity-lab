...
- **MI-002-R1 — Reusable Pack Composition Publication-Dependent C7 Correction** — reviewed `authorized-not-started` contract. Scope is limited to immutable digest-verified predecessor recovery bytes, bounded revalidation, affected MI-002 evidence, and canonical publication/state bindings.
...
**MI-002 — Reusable Pack Composition** retains its exact active candidate lock aggregate `73bbb7c9199a79e00208115f1f7ba469be7e42e1bd20d1d72bfc726ac048df26`. Original execution evidence records 23/23, Level 1 14/14, and backlog-next 68/68. After publication, the C7 test fixture's relative `HEAD` binding produces 22/23 because it supplies the wrong recovery package bytes. MI-002-R1 is authorized-not-started to correct only that fixture and dependent evidence. MI-003 and broader implementation remain blocked.
