...
|---|---|---|---|
| `README.md` | Ratified | Program | Repository orientation; preserves MI-002, MI-003, and MI-003-R1 history, records the MI-003-R2 UNCONDITIONAL PASS closure, and records the MI-004 UNCONDITIONAL PASS execution closure |
| `CONTINUITY-NEXT-STEPS.md` | Ratified | Program | Exact fresh-session handoff for contracting MI-005 or a separately contracted execution of the selected effort |
...
| `docs/70-implementation/README.md` | Ratified | Implementation | Preserves historical results, records the completed MI-003-R2 UNCONDITIONAL PASS correction slice, and records the completed MI-004 UNCONDITIONAL PASS authorized-context slice |
...
| `docs/90-state/program-state.md` | Ratified | Program | Active truth: immutable MI-003 and MI-003-R1 failures, the MI-003-R2 and MI-004 UNCONDITIONAL PASS results, the authorized Level 4 Context Pack, the active Level 3 route, and blocked MI-005+ |
