...
|---|---|---|---|
| `README.md` | Ratified | Program | Repository orientation; preserves MI-002 and MI-003 history and records the MI-003-R1 authorized-not-started publication candidate |
| `CONTINUITY-NEXT-STEPS.md` | Ratified | Program | Exact fresh-session handoff for publication of the nine-path MI-003-R1 contract candidate |
...
| `docs/70-implementation/README.md` | Ratified | Implementation | Preserves historical results and records the bounded MI-003-R1 canonical-read-order correction retry boundary |
...
| `docs/90-state/program-state.md` | Ratified | Program | Active truth: immutable MI-003 failure and finalized authorized-not-started MI-003-R1 contract candidate |
...
| `sessions/MI-003-R1-bounded-local-work-and-scope-canonical-read-order-correction-retry/context-pack.yaml` | Ratified | Session | Finalized authorized-not-started MI-003-R1 contract preserving MI-003 history and correcting only canonical read discipline |
| `sessions/MI-003-R1-bounded-local-work-and-scope-canonical-read-order-correction-retry/prompt.md` | Provisional | Session | Preserved future MI-003-R1 execution instruction requiring exact publication binding and Program-State-first discipline |
| `sessions/MI-003-R1-bounded-local-work-and-scope-canonical-read-order-correction-retry/session-handoff.md` | Ratified | Session | MI-003-R1 contract handoff with exact bindings, immutable-history disposition, correction boundary, and publication-only continuation |
