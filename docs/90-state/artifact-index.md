...
|---|---|---|---|
| `README.md` | Ratified | Program | Repository orientation; preserves MI-002 through MI-004 history and records the superseded SE-001, the executed SE-001-R1 UNCONDITIONAL FAIL, the MI-004-R1 UNCONDITIONAL PASS correction, and the executed SE-001-R2 UNCONDITIONAL FAIL |
| `CONTINUITY-NEXT-STEPS.md` | Ratified | Program | Current-state summary and handoff pointer for the SE-001-R3 correction contract after the executed SE-001-R2 UNCONDITIONAL FAIL |
