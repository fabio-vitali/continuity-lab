...
|---|---|---|---|
| `README.md` | Ratified | Program | Repository orientation; preserves MI-002, MI-003, and MI-003-R1 history, records the MI-003-R2 and MI-004 UNCONDITIONAL PASS closures, and records the contracted not-executed SE-001 candidate |
| `CONTINUITY-NEXT-STEPS.md` | Ratified | Program | Exact fresh-session handoff for publishing the SE-001 selected-effort execution contract |
...
| `docs/70-implementation/README.md` | Ratified | Implementation | Preserves historical results, records the completed MI-003-R2 and MI-004 UNCONDITIONAL PASS slices, and records the contracted not-executed SE-001 selected-effort execution |
...
| `docs/90-state/program-state.md` | Ratified | Program | Active truth: immutable MI-003 and MI-003-R1 failures, the MI-003-R2 and MI-004 UNCONDITIONAL PASS results, the authorized Level 4 Context Pack, the active Level 3 route, the contracted not-executed SE-001 candidate, and blocked MI-005+ |
...
| `sessions/SE-001-selected-effort-execution-dashboard-bff-awaiting-confirmation-activity-gap/context-pack.yaml` | Provisional | Session | Reviewed SE-001 selected-effort execution contract publication candidate; neither published nor executed |
| `sessions/SE-001-selected-effort-execution-dashboard-bff-awaiting-confirmation-activity-gap/prompt.md` | Provisional | Session | Preserved future SE-001 execution instruction; usable only after exact publication and a separate explicit execution instruction |
| `sessions/SE-001-selected-effort-execution-dashboard-bff-awaiting-confirmation-activity-gap/session-handoff.md` | Provisional | Session | SE-001 contract-authoring closure with exact bindings, contract identity, manifest, and publication handoff |
| `sessions/SE-001-selected-effort-execution-dashboard-bff-awaiting-confirmation-activity-gap/changed-files.txt` | Provisional | Session | Exact nine-path continuity-lab manifest for SE-001 contract authoring, review, and finalization |
