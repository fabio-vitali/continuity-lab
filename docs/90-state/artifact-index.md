...
|---|---|---|---|
| `README.md` | Ratified | Program | Repository orientation; preserves MI-002 and MI-002-R1 history and records the completed MI-002-R2 PASS candidate publication boundary |
| `CONTINUITY-NEXT-STEPS.md` | Ratified | Program | MI-003 contract-authoring handoff after published MI-002-R2 closure |
...
| `docs/70-implementation/README.md` | Ratified | Implementation | Preserves historical results and records immutable MI-002-R1 FAIL plus published MI-002-R2 unconditional PASS |
...
| `docs/90-state/program-state.md` | Ratified | Program | Active truth: MI-002-R1 immutable FAIL, MI-002-R2 published PASS, and MI-003 selected-contract-required but unauthorized |
