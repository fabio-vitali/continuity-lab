...
35. SD-001 — Sustained Dogfooding Bootstrap — contracted-published 2026-07-18 under DR-0024; the first bounded contract of the sustained-dogfooding validation period against the twelve Product Foundation success criteria: on execution it freezes the contracted measurement protocol and opens the append-only dogfooding ledger under continuity/evidence/sd-001/ (operational definitions for non-trivial Work Items, sampled resumptions, multi-item efforts, and overhead sampling; every count derived from existing store artifacts and contemporaneous ledger appends; weekly cadence; no new product mechanism ahead of evidence), records the owner-confirmed period-start marker, and establishes the standing period rules with the pinned engine frozen; the period begins at the SD-001-PUB publication commit on Nestfolio main; the period verdict is a separately contracted later session and is never issued by SD-001; execution and publication remain blocked pending explicit authorization
