...
**MI-002-R1 — Reusable Pack Composition Publication-Dependent C7 Correction** is the sole active correction contract with status `authorized-not-started`. It may only bind the isolated recovery fixture to immutable digest-verified predecessor bytes, rerun bounded validation, regenerate affected evidence, and correct publication bindings and state. MI-003 remains unauthorized and is blocked while R1 is pending. MI-004 through MI-007 and broader work remain blocked.
